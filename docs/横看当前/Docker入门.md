...
title: Docker入门
toc: true
date: 2018-04-24 15:44:44
tags: docker
categories:
---
<img src=" /images/Docker.png" align=center/>
...
命令行运行`docker`命令的时候，需要本机有 Docker 服务。如果这项服务没有启动，可以用下面的命令启动
...
一个文本文件,用来配置 image。Docker根据 该文件生成二进制的image文件
...
- **image是二进制文件**。实际开发中，一个 image 文件往往通过继承另一个 image 文件，加上一些个性化设置而生成。举例来说，你可以在 Ubuntu 的 image 基础上，往里面加入 Apache 服务器，形成你的 image
...
- image 文件是通用的，一台机器的 image 文件拷贝到另一台机器，照样可以使用。Docker 的官方仓库 [Docker Hub](https://hub.docker.com/) 是最重要、最常用的 image 仓库。
...
### 准备工作
 ...
 [下载源码](https://github.com/ruanyf/koa-demos/archive/master.zip)
...
> - [docker vs 虚拟机](http://www.less-is-more.top/wiki/%E7%BA%B5%E8%A7%82%E5%8F%A4%E4%BB%8A/docker-vs-%E8%99%9A%E6%8B%9F%E6%9C%BA/)
> - [八个Docker的真实应用场景](http://www.docker.org.cn/docker/151.html)
